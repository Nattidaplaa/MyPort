...
const Profile = () => {
  return (
    <>
      <div id="profile" className="top"></div>
      <div>
        <div className="name">
          {" "}
        ...
        <div className="card">
          ...
          <div className="message">
            <p>
              I graduated with a bachelor's degree of Computer Engineering,
              Prince of Songkla University phuket campus.I have the ability to
              design websites, create applications and ready to learning new
              things all the time. I intend to be a programmer because I want to
              work in the field of web writing and with the hope that I will
              work directly with the field I studied.
            </p>
          </div>
        </div>
      </div>
